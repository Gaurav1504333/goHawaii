...
const fontFilePath12 = path.join(__dirname, 'MuseoSans_700.otf');
...
'rsbg.png','rss1.png','rss2.png','rss3.png','scroll1.png','scroll2.png','scroll3.png','scroll4.png','scroll5.png','scroll6.png','ss1.png','ss2.png','ss3.png','ss4.png','ss5.png','ss6.png','ss7.png','ss8.png','ss9.png','ss10.png','twitter.png','meta.png'];
...
const server = http.createServer((req, res) => {
    ...
    }else if (req.url === '/MuseoSans_700.otf') {
